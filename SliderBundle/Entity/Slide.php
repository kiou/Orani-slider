 ...
 * @ORM\Entity(repositoryClass="SliderBundle\Repository\SlideRepository")
...
class Slide
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="SliderBundle\Entity\Slider", inversedBy="slides")
     */
    private $slider;
    ...
    {
        return __DIR__.'/../../../web/img/slider/slide/';
    }
     ...
     * Set slider
     *
     * @param \SliderBundle\Entity\Slider $slider
     *
     * @return Slide
     */
